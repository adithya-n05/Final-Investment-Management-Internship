...
wb_list = []
final_wb_directory = "/Users/adithyanarayanan/Dropbox/Desktop/Tristar Final/Positions/Version 2/JPM/BBG Upload Template (Blank).xlsx"
final_wb_directory_save = "/Users/adithyanarayanan/Dropbox/Desktop/Tristar Final/Positions/Version 2/JPM/BBG Upload Template (Ready).xlsx"
path = "/Users/adithyanarayanan/Dropbox/Desktop/Tristar Final/Positions/Version 2/JPM/JPM position statements"
...
for i in range(len(Security_Name_list)):
    if "Cash Account" in Security_Name_list[i]:
        if Quantity_list[i] != 0:
            ...
            New_price_list.append(Market_value_base_currency_list[i])
    else:
