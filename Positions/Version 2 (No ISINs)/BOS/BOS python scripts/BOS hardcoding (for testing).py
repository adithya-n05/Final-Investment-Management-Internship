...
wb_list = []
final_wb_directory = "/Users/adithyanarayanan/Dropbox/Desktop/Tristar Final/Positions/Version 2/BOS/BBG Upload Template (Blank).xlsx" 
final_wb_directory_save = "/Users/adithyanarayanan/Dropbox/Desktop/Tristar Final/Positions/Version 2/BOS/BBG Upload Template (Ready).xlsx"
path = "/Users/adithyanarayanan/Dropbox/Desktop/Tristar Final/Positions/Version 2/BOS/BOS position statements"
...
# This section checks and changes the values of the Price and Quantity values based on whether "Current account" is found in the name of the security
...
for i in range(len(New_security_ID_list_final)):
    if str(New_security_ID_list_final[i]) == "nan":
        ...
        New_price_list2.append(Cost_price_final[i])
